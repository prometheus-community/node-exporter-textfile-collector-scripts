...
metrics = {
    "ctrl_info": Gauge(
        ...
        labelnames=["controller", "model", "serial", "fwversion"],
        namespace=namespace,
        registry=registry,
    ),
    ...
    "vd_info": Gauge(
        ...
        labelnames=["controller", "DG", "VG", "name", "cache", "type", "state"],
        namespace=namespace,
        registry=registry,
    ),
    "pd_shield_counter": Gauge(
        ...
        labelnames=["controller", "enclosure", "slot"],
        namespace=namespace,
        registry=registry,
    ),
